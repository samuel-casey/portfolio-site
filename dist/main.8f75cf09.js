...
function renderData(data) {
  if (data[0].type === 'blog') {
    data.forEach(function (row) {
      var newPost = new _classes.BlogPost(row.title, row.tag, row.url);
      console.log(newPost);
      return newPost;
    });
  } else {
    data.forEach(function (row) {
      var newCard = new _classes.ProjectCard(row.title, row.image, row.description, row.techStack, row.url);
      console.log(newCard);
      return newCard;
    });
  }
...
// 	return data;
// }
},{"jquery":"../node_modules/jquery/dist/jquery.js","./classes":"../js/classes.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
